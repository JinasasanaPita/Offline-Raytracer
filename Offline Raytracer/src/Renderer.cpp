...
void Renderer::RenderImage()
{
	...
	std::shared_ptr<Material> groundMat =
		std::make_shared<Lambertian>(SMath::Vector3(0.8, 0.8, 0.0));
	std::shared_ptr<Material> centerSphereMat =
		std::make_shared<Lambertian>(SMath::Vector3(0.7, 0.3, 0.3));
	std::shared_ptr<Material> leftSphereMat =
		std::make_shared<Metal>(SMath::Vector3(0.8, 0.8, 0.8), 0.3);
	std::shared_ptr<Material> rightSphereMat =
		std::make_shared<Metal>(SMath::Vector3(0.8, 0.6, 0.3), 1.0);
